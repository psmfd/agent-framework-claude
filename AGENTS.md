...
tests/expertise-create/run-tests.sh         # skills/expertise expertise-create.sh write-back contract (ADR-096)
...
| `kemp-loadmaster-expert` | Domain Specialist | Kemp LoadMaster | Progress Kemp LoadMaster ADC — deployment forms and licensing tiers, Virtual Services/SubVS, scheduling and persistence, health checking, SSL/ACME, HA pairs and cloud HA, ESP/WAF/GSLB, REST API (/access, /accessv2) and PowerShell automation |
